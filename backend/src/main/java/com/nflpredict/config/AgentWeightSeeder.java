 ...
 *
 * <p>Values come from a walk-forward backtest over the 2021-2024 seasons; a
    ...
    public CommandLineRunner seedAgentWeights(AgentWeightRepository repository) {
        return args -> {
            ...
            List<AgentWeight> seeds = List.of(
                    ...
                    // Not backtestable: no historical odds on the free tier and no
                    // historical injury archive. Held at the default weight until a
                    // season of settled live predictions can calibrate them.
                    new AgentWeight("Market Odds", 0.02, null, null, false),
