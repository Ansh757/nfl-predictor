  ...
  return (
    ...
    >
      ...
      <div className="min-w-0">
        <p className="text-sm font-semibold text-content">Waking the prediction service…</p>
      ...
      <span className="ml-auto whitespace-nowrap text-xs font-semibold tabular-nums text-warning">
        {seconds}s
      </span>
    </div>
  );
